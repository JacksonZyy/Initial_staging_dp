...
def handle_fully_connected_layer(man, element,weights, bias,  size, num_pixels, predecessors, num_predecessors, has_two_lbs, random_prune):
    """
    ...
    try:
        ...
        handle_fully_connected_layer_c.argtypes = [ElinaManagerPtr, ElinaAbstract0Ptr, _doublepp, ndpointer(ctypes.c_double),  c_size_t, c_size_t, POINTER(c_size_t), c_size_t, c_bool, c_bool]
        handle_fully_connected_layer_c(man,element,weights, bias,  size, num_pixels, predecessors, num_predecessors, has_two_lbs, random_prune)
        #print("end fcl")
    except Exception as inst:
...
def handle_fully_connected_layer_no_alloc(man, element,weights, bias,  size, num_pixels, predecessors, num_predecessors, has_two_lbs, random_prune):
    """
        handle the first FFN ReLU layer
    ...
    try:
        ...
        handle_fully_connected_layer_no_alloc_c.argtypes = [ElinaManagerPtr, ElinaAbstract0Ptr, _doublepp, ndpointer(ctypes.c_double),  c_size_t, c_size_t, POINTER(c_size_t), c_size_t, c_bool, c_bool]
        handle_fully_connected_layer_no_alloc_c(man,element,weights, bias,  size, num_pixels, predecessors, num_predecessors, has_two_lbs, random_prune)
    except Exception as inst:
...
def handle_sub_layer(man, element, cst, is_minuend, size, predecessors, num_predecessors, has_two_lbs, random_prune):
    """
    ...
    try:
        ...
        handle_sub_layer_c.argtypes = [ElinaManagerPtr, ElinaAbstract0Ptr, ndpointer(ctypes.c_double),  c_bool, c_size_t, POINTER(c_size_t), c_size_t, c_bool, c_bool]
        handle_sub_layer_c(man, element, cst, is_minuend, size, predecessors, num_predecessors, has_two_lbs, random_prune)
    except Exception as inst:
...
def handle_mul_layer(man, element, cst,  size, predecessors, num_predecessors, has_two_lbs, random_prune):
    """
    handle the first FFN log layer
    ...
    try:
        ...
        handle_mul_layer_c.argtypes = [ElinaManagerPtr, ElinaAbstract0Ptr, ndpointer(ctypes.c_double),  c_size_t, POINTER(c_size_t), c_size_t, c_bool, c_bool]
        handle_mul_layer_c(man, element, cst, size, predecessors, num_predecessors, has_two_lbs, random_prune)
    except Exception as inst:
...
def handle_relu_layer_twolb(man, element, num_neurons, predecessors, num_predecessors, use_default_heuristics):
    """
    handle ReLU layer with two symbolic lower bounds
    ...
    try:
        handle_relu_layer_twolb_c = fppoly_api.handle_relu_layer_twolb
        handle_relu_layer_twolb_c.restype = None
        handle_relu_layer_twolb_c.argtypes = [ElinaManagerPtr, ElinaAbstract0Ptr, c_size_t, POINTER(c_size_t), c_size_t,
                                        c_bool]
        handle_relu_layer_twolb_c(man, element, num_neurons, predecessors, num_predecessors, use_default_heuristics)
    except Exception as inst:
        print('Problem with loading/calling "handle_relu_layer" from "libfppoly.so"')
        print(inst)
...
def is_greater(man, element, y, x, use_area_heuristic,has_two_lbs, random_prune):
    """
    ...
    try:
        ...
        is_greater_c.argtypes = [ElinaManagerPtr, ElinaAbstract0Ptr, ElinaDim, ElinaDim, c_bool, c_bool]
        res = is_greater_c(man,element,y, x,has_two_lbs, random_prune)
    except Exception as inst:
        print('Problem with loading/calling "is_greater" from "libfppoly.so"')
        print(inst)
    return res

def handle_convolutional_layer(man, element, filter_weights, filter_bias,  input_size, filter_size, num_filters, strides, output_size, pad_top, pad_left, has_bias, predecessors, num_predecessors, has_two_lbs, random_prune):
    """
    ...
    try:
        ...
        handle_convolutional_layer_c.argtypes = [ElinaManagerPtr, ElinaAbstract0Ptr, ndpointer(ctypes.c_double), ndpointer(ctypes.c_double), ndpointer(ctypes.c_size_t), POINTER(c_size_t), c_size_t, POINTER(c_size_t), POINTER(c_size_t),c_size_t, c_size_t, c_bool, POINTER(c_size_t), c_size_t, c_bool, c_bool]
        handle_convolutional_layer_c(man,element, filter_weights, filter_bias, input_size, filter_size, num_filters, strides, output_size, pad_top, pad_left, has_bias, predecessors, num_predecessors, has_two_lbs, random_prune)
    except Exception as inst:
...
def handle_batchnormalization_layer(man, element, weight_para, bias_para, output_size, input_size, parameter_length, predecessors, num_predecessors, has_two_lbs, random_prune):
    """
    ...
    try:
        ...
        handle_batchnormalization_layer_c.argtypes = [ElinaManagerPtr, ElinaAbstract0Ptr, ndpointer(ctypes.c_double),
                                                 ...
                                                 ndpointer(ctypes.c_size_t), c_size_t, POINTER(c_size_t), c_size_t, c_bool, c_bool]
        handle_batchnormalization_layer_c(man, element, weight_para, bias_para, output_size, input_size, parameter_length, predecessors, num_predecessors, has_two_lbs, random_prune)
    except Exception as inst:
...
def handle_residual_layer(man, element, num_neurons, predecessors, num_predecessors, has_two_lbs, random_prune):
    """
    ...
    try:
        ...
        handle_residual_layer_c.argtypes = [ElinaManagerPtr, ElinaAbstract0Ptr, c_size_t, POINTER(c_size_t), c_size_t, c_bool, c_bool]
        handle_residual_layer_c(man, element, num_neurons, predecessors, num_predecessors, has_two_lbs, random_prune)
    except Exception as inst:
